...
export const ITEM_TYPE_META: Record<ItemType, ItemTypeMeta> = {
  ...
  product: { icon: "📦", label: "Product", color: "#1e40af", bg: "#eff6ff", placeholder: "e.g. Shampoo 500ml, Relaxer cream, Spare part", hint: "Something you sell — shampoo, parts, goods", addLabel: "Add Product", costLabel: "Cost price (R)", sellLabel: "Sell price (R)", showStock: true },
  labour: { icon: "⚒️", label: "Labour", color: "#0369A1", bg: "#F0F9FF", placeholder: "e.g. Plumbing labour, Hourly rate, Call-out fee", hint: "Your time — hourly rate, day rate, call-out fee", addLabel: "Add Labour Rate", costLabel: "Your Cost Rate (R/hr)", sellLabel: "What you charge (R/hr)", showStock: false },
