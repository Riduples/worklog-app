...
export const UPGRADE_DETAILS: Partial<Record<ToolId | "team" | "invoice_recurring", { title: string; desc: string; icon: string }>> = {
  ...
  ageanalysis: { title: "Age Analysis (Customers)", desc: "See who owes you, aged by overdue days. Included from Trade.", icon: "⏳" },
  payables: { title: "Age Analysis (Suppliers)", desc: "See who you owe, aged by overdue days. Included from Trade.", icon: "⏳" },
